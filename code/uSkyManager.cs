...
public class uSkyManager : MonoBehaviour
{
	...
	private bool EnableNightSky => NightSky != NightModes.Off;
	...
	public Vector3 SunDir => (!(m_sunLight != null)) ? new Vector3(0.321f, 0.766f, -0.557f) : (m_sunLight.transform.forward * -1f);
	...
	public float NightTime => 1f - DayTime;
	...
	public Vector2 ColorCorrection => (LinearSpace && Tonemapping) ? new Vector2(0.38317f, 1.413f) : ((!LinearSpace) ? Vector2.one : new Vector2(1f, 2f));
